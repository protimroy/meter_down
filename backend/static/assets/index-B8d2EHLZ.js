(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=document.querySelector(`#app`),t=`./assets/`,n=`${t}dreamina-2026-08-11-9578-REFERENCE IMAGE_ Use as the exact visua....mp4`,r=[{videoId:`YFpxILBZUhg`,title:`Ei Poth Jodi Na Shesh Hoy`,artist:`Hemanta Mukherjee & Sandhya Mukherjee`},{videoId:`VaxT-5zDcuk`,title:`Tui Phele Esechhis Kare`,artist:`Hemanta Mukhopadhyay`},{videoId:`Qk5j8gF74mc`,title:`Amar Ar Hobe Na Deri`,artist:`Hemanta Mukhopadhyay`}],i=null,a=null,o={cabs:[],cab:{id:0,registration:``,status:``},stats:{cabs:0,on_road:0,memories:0,unknown:0},entered:!0,playing:!1,radio:!1,rain:!1,volume:.46,liked:!1,drawer:null,record:null,query:``,submissions:[],pointerX:0,pointerY:0,transition:!1,toast:``,fare:23,trackIndex:0};function s(e=``){return String(e).replace(/[&<>'"]/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,"'":`&#39;`,'"':`&quot;`})[e])}async function c(e,t={}){let n=await fetch(e,t);if(!n.ok){let e=`Request failed`;try{e=(await n.json()).detail||e}catch{}throw Error(e)}return n.json()}var l={stats:()=>c(`/api/stats`),cabs:()=>c(`/api/cabs`),cab:e=>c(`/api/cabs/${e}`),random:()=>c(`/api/cabs/random`),memory:(e,t)=>c(`/api/cabs/${e}/memories`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),submit:e=>c(`/api/submissions`,{method:`POST`,body:e}),submissions:()=>c(`/api/admin/submissions`),approve:e=>c(`/api/admin/submissions/${e}/approve`,{method:`POST`}),reject:e=>c(`/api/admin/submissions/${e}/reject`,{method:`POST`})},u=new class{constructor(){this.ctx=null,this.master=null,this.engine=null,this.engineGain=null,this.engineNoise=null,this.radioNoise=null,this.radioGain=null,this.rainNoise=null,this.rainGain=null,this.cityNoise=null,this.cityGain=null,this.volume=o.volume}ensure(){return this.ctx||(this.ctx=new(window.AudioContext||window.webkitAudioContext),this.master=this.ctx.createGain(),this.master.gain.value=this.volume,this.master.connect(this.ctx.destination)),this.ctx.state===`suspended`&&this.ctx.resume(),this.ctx}setVolume(e){this.volume=e,this.master&&this.master.gain.setTargetAtTime(e,this.ctx.currentTime,.04)}noiseBuffer(e=2){let t=this.ensure(),n=t.createBuffer(1,t.sampleRate*e,t.sampleRate),r=n.getChannelData(0);for(let e=0;e<r.length;e++)r[e]=Math.random()*2-1;return n}startEngine(){let e=this.ensure();if(this.engine)return;let t=e.createOscillator(),n=e.createGain(),r=e.createBiquadFilter();t.type=`sawtooth`,t.frequency.value=44,r.type=`lowpass`,r.frequency.value=180,n.gain.value=.045,t.connect(r).connect(n).connect(this.master),t.start(),this.engine=t,this.engineGain=n;let i=e.createBufferSource(),a=e.createGain(),o=e.createBiquadFilter();i.buffer=this.noiseBuffer(2),i.loop=!0,o.type=`bandpass`,o.frequency.value=90,o.Q.value=.9,a.gain.value=.022,i.connect(o).connect(a).connect(this.master),i.start(),this.engineNoise=i;let s=e.createBufferSource(),c=e.createBiquadFilter(),l=e.createGain();s.buffer=this.noiseBuffer(3),s.loop=!0,c.type=`lowpass`,c.frequency.value=1200,l.gain.value=.008,s.connect(c).connect(l).connect(this.master),s.start(),this.cityNoise=s,this.cityGain=l}stopEngine(){if(!this.ctx||!this.engine)return;let e=this.ctx.currentTime;this.engineGain.gain.setTargetAtTime(1e-4,e,.09),setTimeout(()=>{try{this.engine?.stop()}catch{}try{this.engineNoise?.stop()}catch{}try{this.cityNoise?.stop()}catch{}this.engine=null,this.engineNoise=null,this.cityNoise=null},350)}setRadio(e){let t=this.ensure();if(e&&!this.radioNoise){let e=t.createBufferSource(),n=t.createBiquadFilter(),r=t.createGain();e.buffer=this.noiseBuffer(2),e.loop=!0,n.type=`bandpass`,n.frequency.value=1550,n.Q.value=.7,r.gain.value=.032,e.connect(n).connect(r).connect(this.master),e.start(),this.radioNoise=e,this.radioGain=r,this.radioSweep()}else if(!e&&this.radioNoise){try{this.radioNoise.stop()}catch{}this.radioNoise=null}}radioSweep(){if(!this.radioGain||!this.ctx)return;let e=this.ctx.currentTime;this.radioGain.gain.cancelScheduledValues(e),this.radioGain.gain.setValueAtTime(.012,e),this.radioGain.gain.linearRampToValueAtTime(.04,e+.17),this.radioGain.gain.linearRampToValueAtTime(.018,e+.45)}setRain(e){let t=this.ensure();if(e&&!this.rainNoise){let e=t.createBufferSource(),n=t.createBiquadFilter(),r=t.createGain();e.buffer=this.noiseBuffer(3),e.loop=!0,n.type=`highpass`,n.frequency.value=2700,r.gain.value=.027,e.connect(n).connect(r).connect(this.master),e.start(),this.rainNoise=e,this.rainGain=r}else if(!e&&this.rainNoise){try{this.rainNoise.stop()}catch{}this.rainNoise=null}}click(){let e=this.ensure(),t=e.createOscillator(),n=e.createGain();t.type=`square`,t.frequency.value=120,n.gain.setValueAtTime(.12,e.currentTime),n.gain.exponentialRampToValueAtTime(1e-4,e.currentTime+.06),t.connect(n).connect(this.master),t.start(),t.stop(e.currentTime+.07)}meter(){let e=this.ensure();[0,.06].forEach((t,n)=>{let r=e.createOscillator(),i=e.createGain();r.type=`square`,r.frequency.value=n?740:510,i.gain.setValueAtTime(.06,e.currentTime+t),i.gain.exponentialRampToValueAtTime(1e-4,e.currentTime+t+.025),r.connect(i).connect(this.master),r.start(e.currentTime+t),r.stop(e.currentTime+t+.03)})}horn(){let e=this.ensure();[318,392].forEach((t,n)=>{let r=e.createOscillator(),i=e.createGain();r.type=`sawtooth`,r.frequency.value=t,i.gain.setValueAtTime(1e-4,e.currentTime),i.gain.exponentialRampToValueAtTime(n?.07:.09,e.currentTime+.025),i.gain.setValueAtTime(n?.07:.09,e.currentTime+.3),i.gain.exponentialRampToValueAtTime(1e-4,e.currentTime+.43),r.connect(i).connect(this.master),r.start(),r.stop(e.currentTime+.45)})}door(){let e=this.ensure(),t=e.createBufferSource(),n=e.createBiquadFilter(),r=e.createGain();t.buffer=this.noiseBuffer(.16),n.type=`lowpass`,n.frequency.value=720,r.gain.value=.2,t.connect(n).connect(r).connect(this.master),t.start(),t.stop(e.currentTime+.16)}},d=null,f=0,p=[];function m(e){o.toast=e,D(),clearTimeout(m.timer),m.timer=setTimeout(()=>{o.toast=``,D()},1900)}async function h(e){if(!e)return null;try{return await l.cab(e.id)}catch{return e}}function g(){p.forEach(clearTimeout),p=[];let e=++f,t=[...document.querySelectorAll(`.hero-video`)];if(t.length!==2)return;let n=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches;if(t[0].classList.add(`is-active`),n){t[0].pause();return}let r=0,i=(t,n)=>{let r=setTimeout(()=>{e===f&&t()},n);p.push(r)},a=e=>{let n=Number.isFinite(e.duration)?e.duration:7.1,o=Math.max(.4,n-e.currentTime-.7);i(()=>{let e=+(r===0),n=t[r],o=t[e];o.currentTime=0,o.play().catch(()=>{}),requestAnimationFrame(()=>o.classList.add(`is-entering`)),i(()=>{n.pause(),n.currentTime=0,n.classList.remove(`is-active`),o.classList.remove(`is-entering`),o.classList.add(`is-active`),r=e,a(o)},720)},o*1e3)},o=t[0];o.currentTime=0,o.play().catch(()=>{}),o.readyState>=1?a(o):o.addEventListener(`loadedmetadata`,()=>a(o),{once:!0})}async function _(e=1,t=!1){if(!o.transition){o.transition=!0,D(),u.click(),await new Promise(e=>setTimeout(e,260));try{let n;if(t)n=await l.random();else{let t=Math.max(0,o.cabs.findIndex(e=>e.id===o.cab?.id));n=o.cabs[(t+e+o.cabs.length)%o.cabs.length],n=await h(n)}o.cab=n,o.fare=23}finally{o.transition=!1,D()}}}function v(e){let t=document.querySelector(`[data-action="play"]`),n=document.querySelector(`[data-action="radio"]`);if(!t)return;o.playing=e,o.radio=e,i?.playVideo&&(e?i.playVideo():i.pauseVideo()),document.querySelector(`.home-shell`)?.classList.toggle(`sound-on`,e);let a=r[o.trackIndex];t.setAttribute(`aria-label`,`${e?`Pause`:`Play`} ${a.title}`),t.title=e?`Pause song`:`Play song`,n?.classList.toggle(`is-on`,e),n?.setAttribute(`aria-label`,e?`Pause Radio Kolkata`:`Play Radio Kolkata`)}function y(e){o.trackIndex=(e+r.length)%r.length;let t=r[o.trackIndex],n=document.querySelector(`.track-card p`),a=document.querySelector(`.track-card span`),s=document.querySelector(`[data-action="play"]`);n&&(n.textContent=t.title),a&&(a.textContent=t.artist),s?.setAttribute(`aria-label`,`${o.playing?`Pause`:`Play`} ${t.title}`),i?.loadVideoById&&(o.playing?i.loadVideoById(t.videoId):i.cueVideoById(t.videoId))}function b(){return window.YT?.Player?Promise.resolve(window.YT):a||(a=new Promise(e=>{let t=window.onYouTubeIframeAPIReady;window.onYouTubeIframeAPIReady=()=>{t?.(),e(window.YT)};let n=document.createElement(`script`);n.src=`https://www.youtube.com/iframe_api`,document.head.append(n)}),a)}async function x(){let e=document.querySelector(`#youtube-song`),t=document.querySelector(`[data-action="play"]`);if(!e||!t)return;let n=await b();document.querySelector(`#youtube-song`)&&(i=new n.Player(`youtube-song`,{width:640,height:360,videoId:r[o.trackIndex].videoId,playerVars:{controls:0,disablekb:1,playsinline:1,rel:0,origin:window.location.origin},events:{onReady:()=>{o.playing&&i.playVideo(),t.disabled=!1,t.title=o.playing?`Pause song`:`Play song`},onStateChange:e=>{e.data===n.PlayerState.ENDED&&y(o.trackIndex+1)}}}))}function S(){o.rain=!o.rain,u.setRain(o.rain),D()}function C(){v(!o.playing)}function w(e){o.drawer=e,D()}function T(){o.drawer=null,o.record=null,D()}function E(){o.entered=!0,u.door(),setTimeout(()=>v(!0),180),D()}function D(){if(d&&=(d.destroy(),null),!o.cab){e.innerHTML=`<div class="boot-screen"><div class="boot-dot"></div><p>Warming the meter…</p></div>`;return}o.cab;let i=r[o.trackIndex];e.innerHTML=`
    <main class="home-shell ${o.playing?`sound-on`:``}">
      <section class="motion-hero" aria-label="View from inside a Kolkata Ambassador taxi">
        ...
        <nav class="hero-controls" aria-label="Ride controls">
          ...
          <button data-action="play" class="sound-toggle" aria-label="${o.playing?`Pause`:`Play`} ${s(i.title)}" title="${o.playing?`Pause`:`Play`} song"><span></span></button>
          <button data-action="song-next" aria-label="Next song" title="Next song">▶</button>
        </nav>

        <footer class="hero-footer">
          <button data-action="radio" class="radio-label ${o.radio?`is-on`:``}">RADIO KOLKATA</button>
    ...
    ${O()}
  `,g(),x()}function O(){return o.drawer?o.drawer===`archive`?A():o.drawer===`record`?j(o.record||o.cab):o.drawer===`about`?M():o.drawer===`submit`?N():o.drawer===`memory`?P():o.drawer===`desk`?F():``:``}function k(e,t=``){return`<div class="drawer-backdrop"><aside class="drawer ${t}" role="dialog" aria-modal="true"><button class="drawer-close" data-action="close" aria-label="Close">×</button>${e}</aside></div>`}function A(){let e=o.query.trim().toLowerCase(),t=o.cabs.filter(t=>!e||[t.registration,t.nickname,t.driver_name,t.neighbourhood,t.status].filter(Boolean).join(` `).toLowerCase().includes(e));return k(`
  ...
  `,`archive-drawer`)}function j(e){let t=e.memories||[];return k(`
  ...
  `,`record-drawer`)}function M(){return k(`
  ...
  `,`about-drawer`)}function N(){return k(`
  ...
  `,`form-drawer`)}function P(){return k(`
  ...
  `,`form-drawer memory-drawer`)}function F(){let e=o.submissions.filter(e=>e.moderation_status===`PENDING`),t=o.submissions.filter(e=>e.moderation_status!==`PENDING`),n=e=>e.map(e=>`<article class="desk-row">
  ...
  `,`desk-drawer`)}async function I(e){o.record=await l.cab(e||o.cab.id),o.drawer=`record`,D()}async function L(){o.submissions=await l.submissions(),o.drawer=`desk`,D()}e.addEventListener(`click`,async e=>{if(e.target.classList.contains(`drawer-backdrop`)){T();return}let t=e.target.closest(`[data-action], [data-cab-id], [data-approve], [data-reject]`);if(t){if(t.dataset.cabId){await I(Number(t.dataset.cabId));return}if(t.dataset.approve){try{await l.approve(Number(t.dataset.approve)),o.cabs=await l.cabs(),o.stats=await l.stats(),await L(),m(`Field note promoted to archive.`)}catch(e){m(e.message)}return}if(t.dataset.reject){try{await l.reject(Number(t.dataset.reject)),await L(),m(`Field note rejected.`)}catch(e){m(e.message)}return}switch(t.dataset.action){case`enter`:E();break;case`play`:v(!o.playing);break;case`song-prev`:y(o.trackIndex-1);break;case`song-next`:y(o.trackIndex+1);break;case`next`:await _(1);break;case`prev`:await _(-1);break;case`shuffle`:await _(1,!0);break;case`rain`:S();break;case`radio`:C();break;case`horn`:u.horn(),m(`Kolkata answers back.`);break;case`like`:o.liked=!o.liked,u.click(),D();break;case`archive`:w(`archive`);break;case`about`:w(`about`);break;case`submit`:w(`submit`);break;case`record`:await I(o.cab.id);break;case`memory`:w(`memory`);break;case`desk`:await L();break;case`close`:T()}}}),e.addEventListener(`input`,e=>{if(e.target.matches(`[data-action="volume"]`)&&(o.volume=Number(e.target.value),u.setVolume(o.volume)),e.target.id===`archive-search`){o.query=e.target.value;let t=e.target.selectionStart;D();let n=document.querySelector(`#archive-search`);n?.focus(),n&&n.setSelectionRange(t,t)}}),e.addEventListener(`submit`,async e=>{e.preventDefault();let t=e.target,n=t.querySelector(`#form-error`);try{if(t.id===`taxi-form`){let e=new FormData(t);t.querySelector(`[name="consent"]`).checked||e.set(`consent`,`false`),await l.submit(e),T(),m(`Field note received. It is waiting at the Field Desk.`)}if(t.id===`memory-form`){let e=new FormData(t),n={author_name:e.get(`author_name`)||`Anonymous`,memory:e.get(`memory`),year:e.get(`year`)?Number(e.get(`year`)):null},r=o.record||o.cab;await l.memory(r.id,n),o.record=await l.cab(r.id),o.drawer=`record`,o.stats=await l.stats(),D(),m(`Memory preserved.`)}}catch(e){n&&(n.hidden=!1,n.textContent=e.message)}}),window.addEventListener(`keydown`,async e=>{if(e.key===`Escape`&&o.drawer){T();return}o.drawer||!o.entered||e.code===`Space`&&(e.preventDefault(),v(!o.playing))}),window.addEventListener(`pointermove`,e=>{if(window.matchMedia(`(prefers-reduced-motion: reduce)`).matches)return;let t=(e.clientX/window.innerWidth-.5)*2,n=(e.clientY/window.innerHeight-.5)*2;o.pointerX=t*-5,o.pointerY=n*-3,document.documentElement.style.setProperty(`--pointer-x`,`${o.pointerX}px`),document.documentElement.style.setProperty(`--pointer-y`,`${o.pointerY}px`)}),(function(){D()})(),window.addEventListener(`beforeunload`,()=>localStorage.setItem(`meter-down-liked`,o.liked?`1`:`0`));